...
namespace AbstractSchoolBusinessLogic.BusinessLogic
{
    class SaveToPdf
    {
        public static void CreateDoc(PdfInfo info)
        {
            ...
            if (info.SchoolSuppliesCircles != null)
            {
                ...
                foreach (var pc in info.SchoolSuppliesCircles)
                {
                    CreateRow(new PdfRowParameters
                    {
                        Table = table,
            ...
            else if (info.WarehouseSchoolSupplies != null)
            {
                int sum = 0;
                ...
                foreach (var wc in info.WarehouseSchoolSupplies)
                {
                    CreateRow(new PdfRowParameters
                    {
                        Table = table,
